...
* link:https://tomverbeure.github.io/2022/02/20/GDBWave-Post-Simulation-RISCV-SW-Debugging.html[GDBWave]
  link:https://github.com/tomverbeure/gdbwave[written in C],
* Zephyr RTOS link:https://docs.zephyrproject.org/latest/services/debugging/gdbstub.html[GDB stub]
  link:https://github.com/zephyrproject-rtos/zephyr/tree/main/subsys/debug/gdbstub[written in C],
* OpenOCD link:https://openocd.org/doc/html/GDB-and-OpenOCD.html[GDB server]
  link:https://github.com/riscv-collab/riscv-openocd/blob/riscv/src/server/gdb_server.c[written in C],
* link:https://github.com/agra-uni-bremen/riscv-vp[RISC-V based Virtual Prototype (VP)]
  link:https://github.com/agra-uni-bremen/riscv-vp/tree/master/vp/src/core/common/gdb-mc[gdb-mc written in C++],
* link:https://github.com/qemu/qemu/tree/master/gdbstub[Qemu gdbstub written in C],
* GDB stub library link:https://github.com/mborgerson/gdbstub[gdbstub] written in C,
* Implement GDB Remote Debug Protocol Stub From Scratch (link:https://github.com/nomtats/gdbserver-stub[gdbserver-stub]) written in  JavaScript.
